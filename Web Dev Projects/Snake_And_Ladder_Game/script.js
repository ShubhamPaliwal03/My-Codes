...
function performAction()
{
    if(i % 2 === 1) // red player's turn
    {
        ...
        if(red_player_pos + dice_value <= 100)
        {
            if(red_player_pos + dice_value == 100)
            {
            ...
            const new_cell = removeFromAndMovePlayerTo(red_player_pos, red_player_pos + dice_value)
    
            jumpSound.play()

            if(red_player_pos + dice_value != 100)
            {
                ActionIfSnakeOrLadder(Number(new_cell.id.substr(1)))
            }
        }
        else
        {
    ...
    {   
        ...
        if(blue_player_pos + dice_value <= 100)
        {
            if(blue_player_pos + dice_value == 100)
            {
            ...
            const new_cell = removeFromAndMovePlayerTo(blue_player_pos, blue_player_pos + dice_value)

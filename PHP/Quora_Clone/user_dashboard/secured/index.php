<?php
    if(isset($_COOKIE['username']) && isset($_COOKIE['uid']))
    {
        ...
        {
            $post_title_input = mysqli_real_escape_string($conn, $_POST['post_title']);
            $post_title_input = strip_tags($post_title_input);

            $post_content_input = mysqli_real_escape_string($conn, $_POST['post_content']);
            $post_content_input = strip_tags($post_content_input);
            ...
            <body>
                ...
                <div id="app-container">
                    <div class="flex-navbar">
                        ...
                        <div>
                            <a href="./dashboard.php" title="<?php echo($username);?>">
                                <img class="user_image" id="user-profile-photo" src="<?php echo($user_image);?>" alt="user_profile_photo">
                            </a>
                        </div>

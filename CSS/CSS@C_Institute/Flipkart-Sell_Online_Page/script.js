...
const dropdown_arrow_containers = document.querySelectorAll('.dropdown-arrow-container');

for(let i = 0; i < dropdowns.length; i++)
{
    dropdowns[i].addEventListener('mouseover', () => {
        dropdown_arrow_containers[i].style.transform = "rotate(180deg)";
    });

    dropdowns[i].addEventListener('mouseout', () => {
        dropdown_arrow_containers[i].style.transform = "rotate(0deg)";
    });
}
